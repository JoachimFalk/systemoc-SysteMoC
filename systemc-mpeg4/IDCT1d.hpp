...
class m_idct
  ...
  public:
      ...
      : smoc_graph(name)
    {
      ...
      m_IDCTfly &ifly1 = registerNode(new m_IDCTfly("ifly1",0,0,1,1,0));
      m_IDCTfly &ifly2 = registerNode(new m_IDCTfly("ifly2",0,0,1,1,0));
      m_IDCTfly &ifly3 = registerNode(new m_IDCTfly("ifly3",0,0,1,1,0));
      ...
      m_IDCTaddsub &addsub6 = registerNode(new m_IDCTaddsub("addsub6", 1, 0, 0));
      m_IDCTaddsub &addsub7 = registerNode(new m_IDCTaddsub("addsub7", 1, 0, 0));
      m_IDCTaddsub &addsub8 = registerNode(new m_IDCTaddsub("addsub8", 1, 0, 0));
      m_IDCTaddsub &addsub9 = registerNode(new m_IDCTaddsub("addsub9", 1, 0, 0));
      m_IDCTaddsub &addsub10 = registerNode(new m_IDCTaddsub("addsub10", 1, 0, 0));
