...
namespace smoc_md_ba {
  smoc_mb_ba_lin_buffer_schedule::smoc_mb_ba_lin_buffer_schedule(
    ...
    : smoc_mb_ba_lin_buffer
        (src_md_loop_iterator,
  ...
  void 
  smoc_mb_ba_lin_buffer_schedule::consumption_update(
    ...
    const iter_domain_vector_type& consumed_window_end)
  {
    ...
    //update LOT
    parent_type::consumption_update(
      current_iteration,
      new_schedule_period,
  ...
  void 
  smoc_mb_ba_lin_buffer_schedule::production_update(
    const iter_domain_vector_type& current_iteration,
  ...
  unsigned long 
  smoc_mb_ba_lin_buffer_schedule::calc_num_src_invocations(
    const iter_domain_vector_type& previous_src_iter,
    const iter_domain_vector_type& current_src_iter) const
  {
    long return_value = 0;
  ...
  smoc_md_ba_ui_schedule::create_buffer_analysis_object(
    const smoc_src_md_loop_iterator_kind& src_md_loop_iterator,
    const smoc_snk_md_loop_iterator_kind& snk_md_loop_iterator)
  {
