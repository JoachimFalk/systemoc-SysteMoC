...
public:
  ...
  virtual void dumpInitialTokens(Detail::IfDumpingInitialTokens *it) = 0;
...
: public Detail::FifoStorage<T, smoc_fifo_chan_base>
{
...
public:
  ...
  /// @brief Channel initializer
  typedef typename Detail::FifoStorage<T, smoc_fifo_chan_base>::chan_init chan_init;

  /// @brief Constructor
  smoc_fifo_chan(const chan_init &i)
    : Detail::FifoStorage<T, smoc_fifo_chan_base>(i)
  {}
protected:
  /// @brief See smoc_port_registry
  Detail::PortOutBaseIf *createEntry()
    { return new entry_type(*this); }

  /// @brief See smoc_port_registry
  Detail::PortInBaseIf *createOutlet()
