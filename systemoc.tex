...
\begin{figure}[h]
\centering
\input{actor-sqrloop-fig.tex}
\caption{\label{fig:actor-sqrloop}%
Visual representation of the \code{SqrLoop} actor $A_2$ consisting of \emph{input ports} and \emph{output ports}, \emph{functionality}, and \emph{firing FSM}.}
\end{figure}
