...
Diese Beschreibung wird anschließend im Netzwerkgraph des InfiniBand-HCA, dargestellt in Abbildung \ref{fig:ng-infiniband}, für die \emph{Aktorinstanz} $A_{11}$ verwendet.

\begin{figure}[t]
\centering
%\includegraphics[scale=1]{fig:ng-infiniband.\graphicPostfix}\\
\resizebox{\textwidth}{!}{\input{ng-infiniband-fig.tex}}
\caption{\label{fig:ng-infiniband}%
...
(in Abbildung \ref{fig:ng-infiniband} als Port $i_1$) 
...
wie in Abbildung \ref{fig:ng-infiniband} verwendet,
...
Die Aktoren des Netzwerkgraph, z.B. $A_{1}$ - $A_{17}$ in Abbildung \ref{fig:ng-infiniband}
auf Seite \pageref{fig:ng-infiniband}, werden in dieser Klasse als Klassenvariablen
...
in Abbildung \ref{fig:ng-infiniband} auf Seite \pageref{fig:ng-infiniband}
