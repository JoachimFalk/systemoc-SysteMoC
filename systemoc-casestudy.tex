...
\begin{tabular}{|r|r|r|r|r|}\hline
             & \SysteMoC & SystemC & C++ & Ptolemy \\\hline\hline
 Time $/$ ms & 2060      & 2650    & 9.5 & ---     \\\hline
\end{tabular}
...
The execution times where measured via the linux \code{time} command on an Intel Pentium~IV CPU with 2.80 GHz and 512 MB of main memory.
...
Network graph of the two dimensional \emph{inverse discrete cosinus transform} (IDCT) for 8x8 blocks, composed out of two one dimensional IDCTs.
Which are themselves composed out of primitive arithmetic operations like, e.g., \code{Scale} or \code{AddSub}.
