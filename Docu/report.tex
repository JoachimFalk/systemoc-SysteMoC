...
In the following, a CSP implementation of the classical dining
...
DiningPhilosophers & := & Philosopher_{0} \| Fork_{0} \| \\
...
Where $\oplus$ is addition modulo 4 and $\|$ is parallel composition.
