...
\begin{figure}[h]
\centering
\input{SysteMoC-SystemC-Integration-fig.tex}
...
\end{verbatim}
\input{firing-rules-fork-fig.tex}
...
(i) The conflicting network graph is represented by the \code{hscd\_graph\_petri} class.
...
%  \item connectInterfacePorts: Same method as defined for conflicting network graphs.
...
%% Fifo         & Choice node         & Nonconflicting network graph & FIFO CSP constraint set \\
