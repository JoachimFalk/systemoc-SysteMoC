...
#ifndef INCLUDE_WSDF_2D_DUP4_HPP
#define INCLUDE_WSDF_2D_DUP4_HPP
...
template <typename T>
class m_wsdf_2D_dup4: public smoc_actor {
...
public:
	m_wsdf_2D_dup4( sc_module_name name,
									unsigned size_x,
									unsigned size_y)
      ...
      out3(ns_smoc_vector_init::ul_vector_init[1][1] <<
					 ns_smoc_vector_init::ul_vector_init[size_x][size_y] ),
			out4(ns_smoc_vector_init::ul_vector_init[1][1] <<
					 ns_smoc_vector_init::ul_vector_init[size_x][size_y] )
			
	{
		start = (in(1) && out1(1) && out2(1) && out3(1) && out4(1))
			>> CALL(m_wsdf_2D_dup4::copy_data) 
			>> start;
	}
...
#endif //INCLUDE_WSDF_2D_DUP4_HPP
