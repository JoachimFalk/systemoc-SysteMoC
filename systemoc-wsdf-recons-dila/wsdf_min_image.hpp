...
#ifndef INCLUDE_WSDF_MIN_IMAGE_HPP
#define INCLUDE_WSDF_MIN_IMAGE_HPP
...
///Create the minimum image
///Template parameters:
/// T  : data type of token
template <typename T>
class m_wsdf_min_image: public smoc_actor {
...
private:
	...
	void process() {
		out[0][0] = in1[0][0] < in2[0][0] ? in1[0][0] : in2[0][0];		
	}
	smoc_firing_state start;
	
public:
	m_wsdf_min_image( sc_module_name name,
										unsigned size_x,
										unsigned size_y)
...
#endif //INCLUDE_WSDF_MIN_IMAGE_HPP
