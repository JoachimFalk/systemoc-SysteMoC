...
#ifndef INCLUDE_WSDF_2D_DUP2_HPP
#define INCLUDE_WSDF_2D_DUP2_HPP
...
template <typename T>
class m_wsdf_2D_dup2: public smoc_actor {
...
public:
	m_wsdf_2D_dup2( sc_module_name name,
									unsigned size_x,
									unsigned size_y)
...
#endif //INCLUDE_WSDF_2D_DUP2_HPP
